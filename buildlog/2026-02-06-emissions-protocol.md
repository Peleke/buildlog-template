...
### `7191de6` — feat: ambient emission protocol with edge mapper registry

Files:
- `src/buildlog/core/operations.py`
- `src/buildlog/emissions/__init__.py`
- `src/buildlog/emissions/mappers.py`


### `f33886c` — test: add 54 tests for emissions protocol (unit + property + metamorphic)
...
### `244bc8c` — docs: add qortex integration guide for emission protocol

Files:
- `docs/guides/qortex-integration.md`


### `77dfd47` — fix: self-healing template resolution in create_entry()

Files:
- `src/buildlog/core/operations.py`


### `067c4f9` — test: update test_missing_template for self-healing behavior

Files:
- `tests/test_core_new_ops.py`
